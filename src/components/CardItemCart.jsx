...
export const CardItemCart = product => {
  ...
  const { startAddProductInCart, startRemoveProductInCart, startDeleteProductInCart } =
    useCartStore();
    ...
    >
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', pl: 1, pb: 1 }}>
          <IconButton aria-label="remove" onClick={handleDisminuirQuantity}>
            <Remove />
          </IconButton>
          {cantidad}
          <IconButton aria-label="add" onClick={handleAumentarQuantity}>
            <Add />
          </IconButton>
